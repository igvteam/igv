...
public class ScatterPlotData {
     ...
     */
    private Map<String, String[]> categoryMap; // Attribute keyname, symbol map
    ...
    private ArrayList<String> categoryNames;   // list of names used for symbol map keys
   ...
   * */
    public ScatterPlotData(String title,
        ...
        this.categoryNames = new ArrayList<String>(this.categoryMap.keySet());
   ...
   * */
    ...
    * */
    public int getSymbolKeyIndex(String name) {
        ...
        int nSymbols = categoryNames.size();

        for (int index = 0; index < nSymbols; ++index) {
            if (categoryNames.get(index).equals(name)) {
                symbolIndex = index;
                break;
            }
        }
    ...
    * */
    public String getSymbolKeyValue(String keyName, int sampleIndex) {
        return categoryMap.get(keyName)[sampleIndex];
    }
