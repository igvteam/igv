...
public class CommandExecutorTest extends AbstractHeadedTest {
    ...
    private void setCheckMaxDepth(int maxDepth) throws Exception {
    ...
    private void tstLoadFileURLSpaces(String filename) throws Exception {
        String fileURL = "file://" + org.igv.util.StringUtils.encodeURL(new File(dirPathSpaces, filename).getAbsolutePath());
