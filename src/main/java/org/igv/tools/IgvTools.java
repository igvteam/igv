...
//import org.igv.logging.core.LoggerContext;
//import org.igv.logging.core.appender.ConsoleAppender;
//import org.igv.logging.core.appender.ConsoleAppender.Target;
//import org.igv.logging.core.config.Configuration;
//import org.igv.logging.core.config.LoggerConfig;
//import org.igv.logging.core.layout.PatternLayout;
...
import org.igv.tools.converters.GCTtoIGVConverter;
import org.igv.tools.converters.WigToBed;
import org.igv.tools.sort.Sorter;
import org.igv.tools.sort.SorterFactory;
import org.igv.track.DataType;
import org.igv.track.WindowFunction;
import org.igv.ui.ReadmeParser;
import org.igv.ui.util.MessageUtils;
import org.igv.util.FileUtils;
import org.igv.util.ParsingUtils;
import org.igv.util.ResourceLocator;
import org.igv.util.converters.DensitiesToBedGraph;
import org.igv.variant.util.VCFtoBed;
...
public class IgvTools {
    ...
    static private Logger log = LogManager.getLogger(IgvTools.class);
...
//        log.warn("Ext factor = " + extFactorValue);
        ...
        try {
            ...
            p.setTrackParameters(DataType.COVERAGE, trackLine, tracknames);
