...
public class AlignmentPacker {
    ...
    private void packDense(List<Alignment> alList, RenderOptions renderOptions, List<Row> alignmentRows) {
    ...
    private void packFull(List<Alignment> alList, RenderOptions renderOptions, List<Row> alignmentRows, ReferenceFrame referenceFrame) {
    ...
    private Object getGroupValue(Alignment al, RenderOptions renderOptions) {
