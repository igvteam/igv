package org.igv.alignment.mods;
...
public class BaseModificationRenderer {
    ...
    public static void drawBlock(double bpStart, double locScale, Rectangle rowRect, Graphics g, RenderOptions renderOptions, List<BaseModificationSet> baseModificationSets, AlignmentBlock block, boolean isNegativeStrand) {
