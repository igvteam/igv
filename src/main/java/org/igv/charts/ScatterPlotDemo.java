...
//            methData[i] = 1 - i * Math.random() / sampleCount;
        ...
        dataMap.put(DataType.COPY_NUMBER.toString(), cnData);
        dataMap.put(DataType.GENE_EXPRESSION.toString(), exprData);
        dataMap.put(DataType.DNA_METHYLATION.toString(), methData);
