...
public class SessionElement {
    ...
    static {
        classMap.put("BlatTrack", org.igv.track .BlatTrack.class);
        classMap.put("FeatureTrack", org.igv.track .FeatureTrack.class);
        classMap.put("SequenceTrack", org.igv.track .SequenceTrack.class);
        classMap.put("DataTrack", org.igv.track .DataTrack.class);
        classMap.put("DataSourceTrack", org.igv.track.DataSourceTrack.class);
